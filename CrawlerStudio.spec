...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['run_daily', 'analysis.report', 'analysis.live_view', 'analysis.text_report',
               'extract.documents', 'baidu_api', 'bilibili_rank', 'douban_boards', 'juejin_api', 'toutiao_api'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=EXCLUDES,
